...
This deployment runs closed-loop CARLA 0.9.16 end-to-end simulation with modular OpenADKit containers and Autoware's `autoware_carla_interface`.
...
**https://autowarefoundation.github.io/openadkit/deployment/carla-simulation/**
...
If running remotely, forward noVNC from the machine running the deployment:
...
```bash
docker compose --env-file ../base/base.env --env-file carla-simulation.env -f docker-compose.yaml down
```
